...
function makePerson (name, birthday, ssn) {
  return person = {name: name, birthday: birthday, ssn: ssn}
...
return creditCard = {cardNumber: cardNumber, expirationDate: expirationDate, securityCode: securityCode} 
}
